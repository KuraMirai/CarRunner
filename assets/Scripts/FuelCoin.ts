...
import { _decorator, Component, Node, Collider2D, IPhysics2DContact, Contact2DType, Vec2, Vec3, RigidBody2D, Sprite, UIOpacity } from 'cc';
...
@ccclass('FuelCoin')
export class FuelCoin extends Component implements ICollidable {
    @property(Collider2D)
    collider!: Collider2D;
